classdef SequentialMixedIntegerConvexPlanner < MixedIntegerConvexProgram
  properties
    I
    m
    N = 2
  ...
  methods
    function obj = SequentialMixedIntegerConvexPlanner(I, m, N, dt, z_fixed_array, w_fixed_array, F_fixed_array, M_fixed_array, has_symbolic)
    ...
    function obj = addDefaultConstraintsAndCosts(obj)
      ...
      for i = 1:numel(obj.feet)
        ...
        obj = obj.addVariable(sprintf('r_foot%d',i), 'C', [3, obj.N], -obj.position_max, obj.position_max);
