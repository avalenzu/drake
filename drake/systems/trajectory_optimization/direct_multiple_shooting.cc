#include "drake/systems/trajectory_optimization/direct_multiple_shooting.h"
...
DirectMultipleShootingTrajectoryOptimization::
    DirectMultipleShootingTrajectoryOptimization(
  ...
  auto constraint =
      std::make_shared<systems::SystemDirectShootingConstraint>(*system,
                                                                   context);
...
void DirectMultipleShootingTrajectoryOptimization::DoAddRunningCost(
