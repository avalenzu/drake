classdef QuasiStaticContact 
  ...
  methods
    ...
    function [Aeq,beq] = halfspace(obj,foot_xy,yaw)
      % generate the halfspace constraint Aeq*x=beq for x =
      % [com_x;com_y;weight1;...;weightM]. These
      ...
      for i = 1:obj.num_fsrc_cnstr
        ...
        [rotmat_fsrc_i,A_fsrc_i,b_fsrc_i] = obj.fsrc_cnstr{i}.fsr_cnstr.bodyTransform(yaw(i));
      ...
      Aeq = [eye(2) -support_vert(1:2,:);zeros(1,2) ones(1,obj.num_contact_pts)];
      beq = [0;0;1];
    end
  end
end