...
dt_max = 0.2;
sdot_max = 10;
planning = FixedFootYawCoMPlanning(robot_mass,t,lambda,c_margin,dt_max,sdot_max,Q_comddot,[lfoot_fsrc_cnstr,rfoot_fsrc_cnstr],[lfoot_yaw*ones(1,num_steps) rfoot_yaw*ones(1,num_steps)]);
